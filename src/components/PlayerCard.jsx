...
export default function PlayerCard({ player, showName = false, revealed = false }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden shadow-2xl animate-scale-in"
      ...
      {/* ── photo / SVG area ─────────────────────── */}
      <div className="relative flex justify-center items-end overflow-hidden" style={{ height: 250 }}>
        ...
        {photoUrl ? (
          ...
          <div className="relative flex justify-center items-center w-full h-full">
            <div className="absolute inset-0 flex items-center justify-center select-none pointer-events-none"
                 style={{ fontSize: 200, fontWeight: 900, fontFamily: '-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif', color: 'rgba(0,0,0,0.12)', lineHeight: 1 }}>
              {jerseyNumber}
            </div>
            <svg width="180" height="240" viewBox="0 0 180 240" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="90" y="178" textAnchor="middle" dominantBaseline="middle"
                    fontSize="32" fontWeight="900" fontFamily="-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif"
      ...
      <div className="relative z-10 flex flex-col items-center pb-3 gap-1">
        ...
        {showName
          ? <p className="text-white font-bold text-center mt-1 px-2 leading-tight"
               style={{ textShadow:'0 2px 8px rgba(0,0,0,0.8)', fontFamily:'-apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif', fontSize:'clamp(0.85rem,1.5vw,1.05rem)' }}>
              {name}
            </p>
