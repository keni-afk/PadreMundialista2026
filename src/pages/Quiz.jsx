        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full animate-fade-in">
          {QUICK_OPTIONS.map((n, i) => {
            ...
            return (
              ...
              >
                <span style={{ fontFamily: 'Orbitron, sans-serif', fontSize: 'clamp(2rem, 4vw, 3rem)', lineHeight: 1 }}>
                  {n}
                </span>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 gap-8 animate-fade-in">
      ...
      <div className="flex gap-4 flex-wrap justify-center">
        <button
          ...
          style={{ fontFamily: 'Orbitron, sans-serif', background: 'linear-gradient(135deg, #FFB800, #FF8C00)', boxShadow: '0 4px 28px rgba(255,184,0,0.50)', border: 'none' }}
        >
          Jugar de nuevo
        </button>
        <button
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ background: 'rgba(255,184,0,0.18)', border: '1px solid rgba(255,184,0,0.35)', fontFamily: 'Orbitron, sans-serif', fontSize: '0.95rem' }}
          >
            ...
            return (
              ...
              >
                <span
                  ...
                  style={{ background: 'rgba(0,0,0,0.25)', fontFamily: 'Orbitron, sans-serif' }}
                >
                  {style.label}
                </span>
